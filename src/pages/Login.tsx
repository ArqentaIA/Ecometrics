...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden"
      ...
      {/* Subtle gradient blob (Win11 style) */}
      ...
      <div className="animate-fade-slide-up relative z-10 w-full max-w-[400px] mx-4">
        {/* Windows 11 Sign-in Card */}
        <div className="win-acrylic-strong rounded-xl p-8">
          {/* Logo */}
          <div className="flex flex-col items-center mb-7">
            <div className="w-14 h-14 rounded-full bg-primary flex items-center justify-center mb-3 shadow-sm">
              <span className="text-2xl">🌿</span>
            </div>
            <span className="text-base font-semibold text-foreground tracking-tight">IRM Group</span>
            <span className="text-[11px] text-muted-foreground mt-0.5">next gen</span>
            <h1 className="font-heading text-[28px] font-bold text-foreground mt-5 tracking-tight">EcoMetrics</h1>
